        ...
        >
          ...
          <div className="grid min-h-[620px] lg:grid-cols-[0.92fr_1.08fr]">
            <section className="relative overflow-hidden bg-neutral-200">
              <div
                key={`image-${turnKey}-${safeIndex}`}
                className={`absolute inset-0 ${
                  direction === 'next'
                    ? 'animate-[imageTurnNext_560ms_cubic-bezier(0.22,1,0.36,1)]'
                    : 'animate-[imageTurnPrev_560ms_cubic-bezier(0.22,1,0.36,1)]'
                }`}
              >
                <Image
                  src={slide.image}
            ...
            <section className="relative flex flex-col bg-[linear-gradient(135deg,#fffaf2_0%,#ffffff_50%,#f6efe3_100%)]">
              ...
              <div className="flex-1 overflow-hidden px-6 py-8 sm:px-10 sm:py-10">
                ...
                <article
                  key={`page-${turnKey}-${safeIndex}`}
                  className={`mx-auto max-w-xl origin-left ${
                    direction === 'next'
                      ? 'animate-[pageTurnNext_560ms_cubic-bezier(0.22,1,0.36,1)]'
                      : 'animate-[pageTurnPrev_560ms_cubic-bezier(0.22,1,0.36,1)]'
                  }`}
                >
          ...
          <style jsx>{`
            ...
            @keyframes pageTurnNext {
              0% {
                opacity: 0;
                transform: perspective(1000px) rotateY(-18deg) translateX(32px);
                filter: blur(4px);
              }
              45% {
                opacity: 0.75;
