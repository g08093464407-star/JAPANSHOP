...
export default function ProductShareButton({
  ...
  return (
    <button
      ...
      className="group relative flex h-14 min-h-[56px] w-[58px] shrink-0 items-center justify-center overflow-hidden rounded-l-[10px] rounded-r-2xl border border-neutral-950 bg-neutral-950 text-white shadow-sm transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_16px_34px_rgba(15,23,42,0.18)] focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2"
      aria-label="商品をシェアする"
